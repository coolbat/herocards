...
(function () {
  ...
  var STYLE_TEXT = [
    ...
    '.am-seal{position:relative;flex:none;width:34px;height:34px;padding:0;border:none;',
      'border-radius:50%;cursor:pointer;background:#a6332a;color:#fff9e8;',
      'line-height:34px;font-size:16px;text-align:center;',
    ...
    '.am-zoom-btn{width:38px;height:38px;padding:0;border:1px solid rgba(228,194,105,.9);',
      'border-radius:50%;background:rgba(18,51,58,.88);color:#f8e7b8;',
      'font:500 23px/36px system-ui,sans-serif;box-shadow:0 2px 8px rgba(3,12,14,.38);}',
